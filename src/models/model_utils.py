...
class ModelUtils:
    ...
    def load_and_preprocess_mnist():
        """
        Loads the MNIST dataset, preprocesses it for CNN usage, and returns training and testings sets.
        :return: A tuple of tuples: ((x_train, y_train), (x_test, y_test))
        """
    ...
    def create_mnist_model(stochastic_mode):
        ...
        :param stochastic_mode: The mode of stochasticity to use in dropout layers.
