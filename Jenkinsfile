pipeline {
    ...
    stages {
        ...
        stage('TRAIN') {
            ...
            steps {
                ...
                script {
                    ...
                    def save_path = input(id: 'userInputSavePath', message: 'Enter the save path for model weights:', parameters: [string(defaultValue: './data/models/mnist_model.h5', description: 'Model save path', name: 'savePath')])
        ...
        stage('EVALUATE') {
            steps {
                script {
                    def load_path = input(id: 'userInputLoadPath', message: 'Enter the load path for model weights:', parameters: [string(description: 'Model load path', name: 'loadPath', defaultValue: './data/models/mnist_model.h5')])
